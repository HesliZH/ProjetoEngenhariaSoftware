...
// Create page object
$tblprodutos_add = new tblprodutos_add();
...
var ftblprodutosadd = currentForm = new ew.Form("ftblprodutosadd", "add");

// Validate form
ftblprodutosadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tblprodutos_add->descricao->Required) { ?>
		...
		<?php } ?>
		<?php if ($tblprodutos_add->custo_real->Required) { ?>
		...
		<?php if ($tblprodutos_add->preco_venda->Required) { ?>
		...
		<?php if ($tblprodutos_add->qtd_estoque->Required) { ?>
		...
		<?php if ($tblprodutos_add->unidade->Required) { ?>
...
ftblprodutosadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftblprodutosadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $tblprodutos_add->showPageHeader(); ?>
<?php
$tblprodutos_add->showMessage();
?>
<form name="ftblprodutosadd" id="ftblprodutosadd" class="<?php echo $tblprodutos_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($tblprodutos_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tblprodutos_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tblprodutos">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$tblprodutos_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($tblprodutos->descricao->Visible) { // descricao ?>
	<div id="r_descricao" class="form-group row">
		<label id="elh_tblprodutos_descricao" for="x_descricao" class="<?php echo $tblprodutos_add->LeftColumnClass ?>"><?php echo $tblprodutos->descricao->caption() ?><?php echo ($tblprodutos->descricao->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tblprodutos_add->RightColumnClass ?>"><div<?php echo $tblprodutos->descricao->cellAttributes() ?>>
...
<?php if ($tblprodutos->custo_real->Visible) { // custo_real ?>
	<div id="r_custo_real" class="form-group row">
		<label id="elh_tblprodutos_custo_real" for="x_custo_real" class="<?php echo $tblprodutos_add->LeftColumnClass ?>"><?php echo $tblprodutos->custo_real->caption() ?><?php echo ($tblprodutos->custo_real->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tblprodutos_add->RightColumnClass ?>"><div<?php echo $tblprodutos->custo_real->cellAttributes() ?>>
...
<?php if ($tblprodutos->preco_venda->Visible) { // preco_venda ?>
	<div id="r_preco_venda" class="form-group row">
		<label id="elh_tblprodutos_preco_venda" for="x_preco_venda" class="<?php echo $tblprodutos_add->LeftColumnClass ?>"><?php echo $tblprodutos->preco_venda->caption() ?><?php echo ($tblprodutos->preco_venda->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tblprodutos_add->RightColumnClass ?>"><div<?php echo $tblprodutos->preco_venda->cellAttributes() ?>>
...
<?php if ($tblprodutos->qtd_estoque->Visible) { // qtd_estoque ?>
	<div id="r_qtd_estoque" class="form-group row">
		<label id="elh_tblprodutos_qtd_estoque" for="x_qtd_estoque" class="<?php echo $tblprodutos_add->LeftColumnClass ?>"><?php echo $tblprodutos->qtd_estoque->caption() ?><?php echo ($tblprodutos->qtd_estoque->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tblprodutos_add->RightColumnClass ?>"><div<?php echo $tblprodutos->qtd_estoque->cellAttributes() ?>>
...
<?php if ($tblprodutos->unidade->Visible) { // unidade ?>
	<div id="r_unidade" class="form-group row">
		<label id="elh_tblprodutos_unidade" for="x_unidade" class="<?php echo $tblprodutos_add->LeftColumnClass ?>"><?php echo $tblprodutos->unidade->caption() ?><?php echo ($tblprodutos->unidade->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tblprodutos_add->RightColumnClass ?>"><div<?php echo $tblprodutos->unidade->cellAttributes() ?>>
...
<?php if (!$tblprodutos_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $tblprodutos_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $tblprodutos_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$tblprodutos_add->showPageFooter();
if (DEBUG_ENABLED)
