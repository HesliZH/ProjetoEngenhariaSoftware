...
// Create page object
$tblusuario_add = new tblusuario_add();
...
var ftblusuarioadd = currentForm = new ew.Form("ftblusuarioadd", "add");

// Validate form
ftblusuarioadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tblusuario_add->nome->Required) { ?>
		...
		<?php } ?>
		<?php if ($tblusuario_add->usuario->Required) { ?>
		...
		<?php } ?>
		<?php if ($tblusuario_add->senha->Required) { ?>
		...
		<?php } ?>
		<?php if ($tblusuario_add->ativo->Required) { ?>
		...
		<?php if ($tblusuario_add->nivel->Required) { ?>
...
ftblusuarioadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftblusuarioadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $tblusuario_add->showPageHeader(); ?>
<?php
$tblusuario_add->showMessage();
?>
<form name="ftblusuarioadd" id="ftblusuarioadd" class="<?php echo $tblusuario_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($tblusuario_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tblusuario_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tblusuario">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$tblusuario_add->IsModal ?>">
...
<?php if ($tblusuario->nome->Visible) { // nome ?>
	<div id="r_nome" class="form-group row">
		<label id="elh_tblusuario_nome" for="x_nome" class="<?php echo $tblusuario_add->LeftColumnClass ?>"><?php echo $tblusuario->nome->caption() ?><?php echo ($tblusuario->nome->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tblusuario_add->RightColumnClass ?>"><div<?php echo $tblusuario->nome->cellAttributes() ?>>
...
<?php if ($tblusuario->usuario->Visible) { // usuario ?>
	<div id="r_usuario" class="form-group row">
		<label id="elh_tblusuario_usuario" for="x_usuario" class="<?php echo $tblusuario_add->LeftColumnClass ?>"><?php echo $tblusuario->usuario->caption() ?><?php echo ($tblusuario->usuario->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tblusuario_add->RightColumnClass ?>"><div<?php echo $tblusuario->usuario->cellAttributes() ?>>
...
<?php if ($tblusuario->senha->Visible) { // senha ?>
	<div id="r_senha" class="form-group row">
		<label id="elh_tblusuario_senha" for="x_senha" class="<?php echo $tblusuario_add->LeftColumnClass ?>"><?php echo $tblusuario->senha->caption() ?><?php echo ($tblusuario->senha->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tblusuario_add->RightColumnClass ?>"><div<?php echo $tblusuario->senha->cellAttributes() ?>>
...
<?php if ($tblusuario->ativo->Visible) { // ativo ?>
	<div id="r_ativo" class="form-group row">
		<label id="elh_tblusuario_ativo" for="x_ativo" class="<?php echo $tblusuario_add->LeftColumnClass ?>"><?php echo $tblusuario->ativo->caption() ?><?php echo ($tblusuario->ativo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tblusuario_add->RightColumnClass ?>"><div<?php echo $tblusuario->ativo->cellAttributes() ?>>
...
<?php if ($tblusuario->nivel->Visible) { // nivel ?>
	<div id="r_nivel" class="form-group row">
		<label id="elh_tblusuario_nivel" for="x_nivel" class="<?php echo $tblusuario_add->LeftColumnClass ?>"><?php echo $tblusuario->nivel->caption() ?><?php echo ($tblusuario->nivel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tblusuario_add->RightColumnClass ?>"><div<?php echo $tblusuario->nivel->cellAttributes() ?>>
...
<?php if (!$tblusuario_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $tblusuario_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $tblusuario_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$tblusuario_add->showPageFooter();
if (DEBUG_ENABLED)
