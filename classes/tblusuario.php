...
/**
 * Table class for tblusuario
 */
class tblusuario extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tblusuario';
		$this->TableName = 'tblusuario';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "\"tblusuario\"";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('tblusuario', 'tblusuario', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, -1, FALSE, '"id"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nome
		$this->nome = new DbField('tblusuario', 'tblusuario', 'x_nome', 'nome', '"nome"', '"nome"', 200, -1, FALSE, '"nome"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nome->Sortable = TRUE; // Allow sort
		$this->fields['nome'] = &$this->nome;

		// usuario
		$this->usuario = new DbField('tblusuario', 'tblusuario', 'x_usuario', 'usuario', '"usuario"', '"usuario"', 200, -1, FALSE, '"usuario"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->usuario->Required = TRUE; // Required field
		$this->usuario->Sortable = TRUE; // Allow sort
		$this->fields['usuario'] = &$this->usuario;

		// senha
		$this->senha = new DbField('tblusuario', 'tblusuario', 'x_senha', 'senha', '"senha"', '"senha"', 200, -1, FALSE, '"senha"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->senha->Required = TRUE; // Required field
		$this->senha->Sortable = TRUE; // Allow sort
		$this->fields['senha'] = &$this->senha;

		// ativo
		$this->ativo = new DbField('tblusuario', 'tblusuario', 'x_ativo', 'ativo', '"ativo"', 'CAST("ativo" AS varchar(255))', 3, -1, FALSE, '"ativo"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ativo->Sortable = TRUE; // Allow sort
		$this->ativo->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['ativo'] = &$this->ativo;

		// nivel
		$this->nivel = new DbField('tblusuario', 'tblusuario', 'x_nivel', 'nivel', '"nivel"', 'CAST("nivel" AS varchar(255))', 3, -1, FALSE, '"nivel"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nivel->Sortable = TRUE; // Allow sort
		$this->nivel->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "\"tblusuario\"";
	}
	...
	public function insert(&$rs)
	{
		...
		if ($success) {
			...
			$this->id->setDbValue($conn->getOne("SELECT currval('tblusuario_id_seq'::regclass)"));
	...
	{
		global $Language;
		if ($pageName == "tblusuarioview.php")
			return $Language->phrase("View");
		elseif ($pageName == "tblusuarioedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tblusuarioadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tblusuarioview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tblusuarioview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "tblusuarioadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tblusuarioadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tblusuarioedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tblusuarioadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tblusuariodelete.php", $this->getUrlParm());
	}
	...
	public function renderListRow()
	{
		...
		$this->ativo->ViewValue = FormatNumber($this->ativo->ViewValue, 0, -2, -2, -2);
		$this->ativo->ViewCustomAttributes = "";

		// nivel
		$this->nivel->ViewValue = $this->nivel->CurrentValue;
		$this->nivel->ViewValue = FormatNumber($this->nivel->ViewValue, 0, -2, -2, -2);
	...
	public function renderEditRow()
	{
		...
		$this->ativo->EditValue = $this->ativo->CurrentValue;
