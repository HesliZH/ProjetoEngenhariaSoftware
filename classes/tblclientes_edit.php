 ...
 * Page class
 */
class tblclientes_edit extends tblclientes
{
	...
	// Page object name
	public $PageObjName = "tblclientes_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// cpf_cnpj
			$this->cpf_cnpj->setDbValueDef($rsnew, $this->cpf_cnpj->CurrentValue, "", $this->cpf_cnpj->ReadOnly);
