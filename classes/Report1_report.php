...
class Report1 extends DbTableBase
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('Report1', 'Report1', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, -1, FALSE, '"id"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// descricao
		$this->descricao = new DbField('Report1', 'Report1', 'x_descricao', 'descricao', '"descricao"', '"descricao"', 200, -1, FALSE, '"descricao"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->descricao->Sortable = TRUE; // Allow sort
		$this->descricao->SourceTableVar = 'tblprodutos';
		$this->fields['descricao'] = &$this->descricao;

		// custo_real
		$this->custo_real = new DbField('Report1', 'Report1', 'x_custo_real', 'custo_real', '"custo_real"', 'CAST("custo_real" AS varchar(255))', 5, -1, FALSE, '"custo_real"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// preco_venda
		$this->preco_venda = new DbField('Report1', 'Report1', 'x_preco_venda', 'preco_venda', '"preco_venda"', 'CAST("preco_venda" AS varchar(255))', 5, -1, FALSE, '"preco_venda"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// qtd_estoque
		$this->qtd_estoque = new DbField('Report1', 'Report1', 'x_qtd_estoque', 'qtd_estoque', '"qtd_estoque"', 'CAST("qtd_estoque" AS varchar(255))', 5, -1, FALSE, '"qtd_estoque"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// unidade
		$this->unidade = new DbField('Report1', 'Report1', 'x_unidade', 'unidade', '"unidade"', '"unidade"', 200, -1, FALSE, '"unidade"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
