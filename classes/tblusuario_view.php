 ...
 * Page class
 */
class tblusuario_view extends tblusuario
{
	...
	// Page object name
	public $PageObjName = "tblusuario_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "tblusuariolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tblusuariolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tblusuariolist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
