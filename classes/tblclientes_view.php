 ...
 * Page class
 */
class tblclientes_view extends tblclientes
{
	...
	// Page object name
	public $PageObjName = "tblclientes_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "tblclienteslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tblclienteslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tblclienteslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
