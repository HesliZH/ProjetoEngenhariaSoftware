 ...
 * Page class
 */
class tblusuario_list extends tblusuario
{
	...
	// Table name
	public $TableName = 'tblusuario';

	// Page object name
	public $PageObjName = "tblusuario_list";

	// Grid form hidden field names
	public $FormName = "ftblusuariolist";
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["tblusuario"]) || get_class($GLOBALS["tblusuario"]) == PROJECT_NAMESPACE . "tblusuario") {
			$GLOBALS["tblusuario"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["tblusuario"];
		}
		...
		$this->AddUrl = "tblusuarioadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "tblusuariodelete.php";
		$this->MultiUpdateUrl = "tblusuarioupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'tblusuario');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ftblusuariolistsrch";
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->nivel->AdvancedSearch->toJson(), ","); // Field nivel
		if ($this->BasicSearch->Keyword <> "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ftblusuariolistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field nivel
		$this->nivel->AdvancedSearch->SearchValue = @$filter["x_nivel"];
		$this->nivel->AdvancedSearch->SearchOperator = @$filter["z_nivel"];
		$this->nivel->AdvancedSearch->SearchCondition = @$filter["v_nivel"];
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ftblusuariolistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ftblusuariolistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ftblusuariolist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ftblusuariolistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
