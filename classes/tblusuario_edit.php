 ...
 * Page class
 */
class tblusuario_edit extends tblusuario
{
	...
	// Page object name
	public $PageObjName = "tblusuario_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// ativo
			$this->ativo->setDbValueDef($rsnew, $this->ativo->CurrentValue, NULL, $this->ativo->ReadOnly);
