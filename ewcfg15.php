...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'Uze4ZybtKty7a6BI'); // Random key for encryption
...
$PROJECT_ID = "{651BD1C9-A9FD-4A9D-B583-0C9BB2622709}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "POSTGRESQL", "host" => "127.0.0.1", "port" => 5432, "user" => "postgres", "pass" => "postgres", "db" => "empresa", "schema" => "", "qs" => "\"", "qe" => "\"");
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "tblusuario");
...
define(PROJECT_NAMESPACE . "USER_TABLE", "\"tblusuario\"");
